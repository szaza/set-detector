...
public interface Config {
    ...
    String MODEL_FILE = "tiny-yolo-setcards.pb";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "tiny-yolo-setcards.txt"; // The filepath of label file for classes.
