...
import edu.tensorflow.client.api.RetrofitService;
import edu.tensorflow.client.api.dto.ResultDTO;
import edu.tensorflow.client.util.ConfirmationDialog;
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    new RetrofitService().detect(mFile).enqueue(new Callback<ResultDTO>() {
                        @Override
